export class CarData{
  ...
  public static addPids(){
    if(!CarData.loaded){
      ...
      CarData.map["fuelSystemStatus"] = new ObdPid("0103", this.isPidAvailable("0103"), "Fuel", "Engine Fuel Status", "Encoded", "fuelSystemStatus");
CarData.map["calculatedEngineLoad"] = new ObdPid("0104", this.isPidAvailable("0104"), "Engine", "Engine Load", "%", "calculatedEngineLoad");
CarData.map["engineCoolantTemperature"] = new ObdPid("0105", this.isPidAvailable("0105"), "Engine", "Engine Coolant Temperature", "°C", "engineCoolantTemperature","°F", val => (val - 32) * 0.55);
...
CarData.map["intakeAirTemperature"] = new ObdPid("010F", this.isPidAvailable("010F"), "Engine", "Intake Air Temperature", "°C", "intakeAirTemperature","°F", val => (val - 32) * 0.55);
...
CarData.map["catalystTemperatureB1S1"] = new ObdPid("013C", this.isPidAvailable("013C"), "Engine", "Catalyst Temperature Bank 1 Sensor 1", "°C", "catalystTemperatureB1S1","°F", val => (val - 32) * 0.55);
CarData.map["catalystTemperatureB2S1"] = new ObdPid("013D", this.isPidAvailable("013D"), "Engine", "Catalyst Temperature Bank 2 Sensor 1", "°C", "catalystTemperatureB2S1","°F", val => (val - 32) * 0.55);
CarData.map["catalystTemperatureB1S2"] = new ObdPid("013E", this.isPidAvailable("013E"), "Engine", "Catalyst Temperature Bank 1 Sensor 2", "°C", "catalystTemperatureB1S2","°F", val => (val - 32) * 0.55);
CarData.map["catalystTemperatureB2S2"] = new ObdPid("013F", this.isPidAvailable("013F"), "Engine", "Catalyst Temperature Bank 2 Sensor 2", "°C", "catalystTemperatureB2S2","°F", val => (val - 32) * 0.55);
...
CarData.map["ambientAirTemperature"] = new ObdPid("0146", this.isPidAvailable("0146"), "General", "Ambient Air Temperature", "°C", "ambientAirTemperature","°F", val => (val - 32) * 0.55);
...
CarData.map["fuelType"] = new ObdPid("0151", this.isPidAvailable("0151"), "Fuel", "Fuel Type", "Encoded", "fuelType");
...
CarData.map["engineOilTemperature"] = new ObdPid("015C", this.isPidAvailable("015C"), "Engine", "Engine Oil Temperature", "°C", "engineOilTemperature","°F", val => (val - 32) * 0.55);
