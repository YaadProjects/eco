export class CarData{
  ...
  public static addPids(){
    if(!CarData.loaded){
      //Autogenerated with Google Sheets
      CarData.map["fuelSystemStatus"] = new ObdPid("0103", this.isPidAvailable("0103"), "Fuel", "Engine Fuel Status", "", "fuelSystemStatus"," ", val => this.getFuelSystemStatus(val));
